...
Создайте файл и скопируйте в него этот код (очевидно, что нужно сменить «my project» на
...
Один из лучших модулей, который я встречал — `load-grunt-config`.
...
**[Здесь][19] более подробная информация по конфигурированию
