...
Если вы к этому моменту закончили делать свой проект по инструкции выше, сейчас
...
Мне нравится этот небольшой отчет, который выдаёт `time-grunt`. Я могу увидеть
...
Вы также можете запустить `grunt watch`, если вам нужно следить за изменениями
