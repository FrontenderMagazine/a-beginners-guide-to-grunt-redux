...
[libsass](http://libsass.org/) C++ компилятор, и не требует установленных
...
Скопируйте в созданный файл этот код (очевидно, что нужно сменить ссылку с ‘my project’ на
...
Скопируйте и вставьте конфигурацию для каждой из задач в соответствующий файл.
...
`watch` запускает специфичные задач при изменении в наблюдаемых файлах - при добавлении, редактировании 
или удалении.
...
в ваших `.scss` и `.js` файлах и автоматически запускать выполнение `sass` или `jshint`
и `uglify`.
